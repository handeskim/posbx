                                    ...
                                    <div id="lefttop" style="margin-bottom:5px;">
                                        <div class="form-group" style="margin-bottom:5px;">
                                            <div class="input-group">
                                                <?php foreach($customers as $customer){ $cus[$customer->id] = $customer->name.($customer->phone ? '-'.$customer->phone : '') ; } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <?=lang('comment2', 'nComment2')?>
                            <textarea class="form-control kb-text" id="nComment2"></textarea>
                        </div>
                    </div>
                </div>
            </div>
