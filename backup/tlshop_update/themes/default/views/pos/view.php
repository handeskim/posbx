                                ...
                                <table class="table table-striped table-condensed">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center; width: 26%; border-bottom: 2px solid #ddd;"><?=lang('comment');?></th>
                                            <th style="text-align:center; width: 26%; border-bottom: 2px solid #ddd;"><?=lang('comment2');?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        foreach ($rows as $row) {
                                            ...
                                            echo '<td style="text-align:left;">' . $row->comment2 .'</td>';
                                            echo '</tr>';
                                        }
                                        ?>
                                    </tbody>
                                    <tfoot>
                                        ...
                                        <?php
                                        if ($inv->order_tax != 0) {
                                            echo '<tr><th colspan="3" style="text-align:left;">' . lang("order_tax") . '</th><th colspan="3" style="text-align:right;">' . $this->tec->formatMoney($inv->order_tax) . '</th></tr>';
                                        }
                                        ...
                                        <tr>
                                            <th colspan="3" style="text-align:left;"><?= lang("paid_amount"); ?></th>
                                            <th colspan="3" style="text-align:right;"><?= $this->tec->formatMoney($inv->paid); ?></th>
                                        </tr>
                                        <tr>
                                            <th colspan="3" style="text-align:left;"><?= lang("due_amount"); ?></th>
                                            <th colspan="3" style="text-align:right;"><?= $this->tec->formatMoney($inv->grand_total - $inv->paid); ?></th>
                                        </tr>
                                        <?php } ?>
                                    </tfoot>
                                </table>
