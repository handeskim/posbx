    ...
    function index($sid = NULL, $eid = NULL) {
        ...
        if ($this->form_validation->run() == true) {
            ...
            for ($r = 0; $r < $i; $r++) {
                ...
                $item_comment2 = $_POST['item_comment2'][$r];
                $item_remove_qty = $_POST['remove_qty'][$r];
                ...
                if (isset($item_id) && isset($real_unit_price) && isset($item_quantity)) {
                    ...
                    $products[] = array(
                        ...
                        'comment2' => $item_comment2,
                        'remove_qty' => $item_remove_qty,
        ...
        else
        {
            ...
            if(isset($sid) && !empty($sid)) {
                ...
                foreach ($inv_items as $item) {
                    ...
                    $row->comment2 = $item->comment2;
                    $row->remove_qty = $item->remove_qty;
